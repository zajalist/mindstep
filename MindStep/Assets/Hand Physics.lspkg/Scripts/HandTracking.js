...
// @input Component.RenderMeshVisual leftHandMesh {"showIf": "enableLeftHandOccluder"}
// @input bool enableLeftHandCollider {"label":"Enable Collider"}
// @input Physics.ColliderComponent leftHandCollider {"showIf": "enableLeftHandOccluder"}
//@ui {"widget":"group_end"}
...
// @input Component.RenderMeshVisual rightHandMesh {"showIf": "enableRightHandOccluder"}
// @input bool enableRightHandCollider {"label":"Enable Collider"}
// @input Physics.ColliderComponent rightHandCollider {"showIf": "enableRightHandCollider"}
//@ui {"widget":"group_end"}
...
global.hand = function(handTracking, handMesh, handCollider, showHandOccluder, showHandCollider, isLeftHand) {
    ...
    if (handMesh !== undefined) {
        ...
        this.handCollider = handCollider;
        this.showHandOccluder = showHandOccluder;
        this.showHandCollider = showHandCollider;
        this.handMesh.enabled = showHandOccluder;
        this.handCollider.enabled = showHandCollider;
    }
};
...
global.hand.prototype.update = function() {
    ...
    if (!wasTracking && this.isTracking) {
        ...
        if (this.handMesh !== undefined) {
            this.handMesh.enabled = this.showHandOccluder;
            this.handCollider.enabled = this.showHandCollider;
        }
    }
};
...
Object.defineProperty(global.hand.prototype, "right", {
    get: function() {
        this._right = this.rotation.multiplyVec3(vec3.right());
        return this._right;
    }
});
...
script.leftHand = new global.hand(script.handTrackingLeft, script.leftHandMesh,script.leftHandCollider, script.enableLeftHandOccluder, script.enableLeftHandCollider, true);
script.rightHand = new global.hand(script.handTrackingRight, script.rightHandMesh,script.rightHandCollider, script.enableRightHandOccluder, script.enableRightHandCollider, false);
